...
namespace ASUTP.Network {
    public class TcpClientAsync
    {
        ...
        {
            if (m_evWrite.WaitOne (TCPServer.WAIT_TIME_MS, true) == true)
            {
                //Запись разрешена
        ...
        private void ConnectCallback(IAsyncResult result)
        {
            ...
            delegateConnect?.Invoke(m_tcpClient, null);
        }
        ...
        {
            m_evWrite.WaitOne (TCPServer.WAIT_TIME_MS, true);
        ...
        {
            delegateErrorConnect?.Invoke(m_ValueToCreate);
        }
    }
}
    ...
    public class TcpServerAsync
    {
        ...
        public int Start()
        {
            ...
            try {
                ...
                Logging.Logg().Exception(e, @"tcpListener.Start()", Logging.INDEX_MESSAGE.NOT_SET);
                iRes = -1;
            }
        ...
        private void AcceptTcpClientCallback(IAsyncResult result)
        {
            ...
            catch (Exception e)
            {
                ...
                //Logging.Logg().Exception(e, "TCPServerAsync::AcceptTcpClientCallback () - ожидаемое исключение", Logging.INDEX_MESSAGE.NOT_SET);
            ...
            if (err == 0)
            {
                ...
                if (read == 0)
                {
                    ...
                    catch (Exception e)
                    {
                        ...
                        Logging.Logg().Exception(e, @"TcpServerAsync::ReadCallBack () - ...", Logging.INDEX_MESSAGE.NOT_SET);
                    }
                }
                else
                {
